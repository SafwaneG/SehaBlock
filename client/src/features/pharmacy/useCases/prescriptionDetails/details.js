...
function Details({ selectedPrescreption, handleSignByPharmacy }) {
  return (
    <>
      <CardContent>
              ...
              <TableBody>
                {selectedPrescreption?.medications.map((medication, index) => (
                  <TableRow key={index}>
                    ...
                    <TableCell>
                      <Button
                        disabled={medication.signedbyPharmacie}
                        variant="outlined"
                        color="error"
                        size="small"
                        sx={{ mr: 2 }}
                        onClick={() => handleSignByPharmacy(medication)}
                      >
                        {medication.signedbyPharmacie ? "Signed" : "Sign"}
                      </Button>
                    </TableCell>{" "}
                  </TableRow>
                ))}
